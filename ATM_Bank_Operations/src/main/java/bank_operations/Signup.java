...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("bank_operations/icons/logo.jpg"));
	...
	add(dateChooser);
        ...
        t3.setBounds(300,320,400,30);
        add(t3);
        
        l8.setBounds(100,370,200,30);
        add(l8);
        
        r3.setBounds(300,370,100,30);
        add(r3);
        
        r4.setBounds(450,370,100,30);
        add(r4);
        
        r5.setBounds(635,370,100,30);
        add(r5);
        ...
        t4.setBounds(300,420,400,30);
        add(t4);
        
        l10.setBounds(100,460,200,30);
        add(l10);
        
        t5.setBounds(300,460,400,30);
        add(t5);
        
        l11.setBounds(100,510,200,30);
        add(l11);
        
        t6.setBounds(300,510,400,30);
        add(t6);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if(t6.getText().equals("")){
               ...
               // String q1 = "insert into signup values('"+formno+"','"+name+"','"+fname+"','"+gender+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+pincode+"','"+state+"')";
